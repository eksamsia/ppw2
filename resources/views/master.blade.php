...
@section('content')
    ...
    <head>
        ...
        <!-- SEO Meta Tags -->
        <meta name="description" content="uas ppw2">
        <meta name="author" content="eksam">
    ...
    <nav id="navbarExample" class="navbar navbar-expand-lg fixed-top navbar-light" aria-label="Main navigation">
        <div class="container">
            ...
            <!-- Image Logo -->
            <a class="navbar-brand logo-image" href="index.html"><img src="images/img/logo2.png" alt="alternative"></a>
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ms-auto navbar-nav-scroll">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="article.html">Tentang Kami</a>
                    </li>
                    <li class="nav-item">
